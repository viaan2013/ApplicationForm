...
public class EndToEndUSA {
	...
	public static void main(String[] args) throws AWTException, InterruptedException {
		...
		//Firstname
		driver.findElement(By.id("firstName")).sendKeys("regression@26.06.2018");
		//Last name
		...
		//zipcode
		driver.findElement(By.id("address.zipcode")).sendKeys("12345678901234567890");
		//country
	    ...
	    driver.findElement(By.id("correspondenceAddress.zipcode")).sendKeys("12345678901234567890");
